...
class CreateEntry(tk.Frame):
    def __init__(self, parent, controller):
        newEntry_fields = 'Last Name', 'First Name', 'Location', 'Title', 'Office Phone', 'Mobile Phone', 'Ext', 'eMail'
        entries = []
...
def fetch(entries):
    ...
    print(make_new_entry(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]))
